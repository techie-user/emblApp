...
import org.embl.emblApp.service.IPersonService;
...
/**
 * REST controller for managing {@link org.embl.emblApp.domain.Person}.
 */
@RestController
@RequestMapping("/api")
public class PersonResource {
    ...
    public PersonResource(IPersonService personService) {
